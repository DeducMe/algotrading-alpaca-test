import { getPortfolioHistory, getTickerHistory } from "./queries/getQueries";
...
(function () {
  ...
  app.get("/api/positions", (req: any, res: any) =>
    recieverAlpaca(req, res, getPositions, alpaca)
  );
  ...
  app.get(
    "/api/tickers/:ticker/:start/:end/:timeframe",
    (req: any, res: any) => {
      recieverAlpaca(req, res, getTickerHistory, alpaca);
    }
  );
